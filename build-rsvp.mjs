...
const partyCss='<style data-party-time="v7">.party-time-card{position:relative;max-width:500px;margin:24px auto 26px;padding:18px 20px;text-align:center;border:1.5px solid #b49a72;border-radius:22px;background:#fff;box-shadow:0 10px 28px rgba(49,88,137,.08)}.party-time-card:before,.party-time-card:after{content:"✦";position:absolute;color:#b49a72;font-size:.8rem}.party-time-card:before{left:14px;top:10px}.party-time-card:after{right:14px;bottom:10px}.party-time-card .time-kicker{display:block;color:#ef7950;font:800 .58rem Montserrat,Arial,sans-serif;letter-spacing:.2em}.party-time-card .time-value{display:block;margin:5px 0 2px;color:#315889;font:800 clamp(1.8rem,7vw,2.5rem) Montserrat,Arial,sans-serif}.party-time-card .time-note{display:block;color:#718095;font:500 .68rem/1.45 Montserrat,Arial,sans-serif}@media(max-width:600px){.party-time-card{margin:20px 8px 23px;padding:17px 14px}.party-time-card .time-value{font-size:1.6rem}}</style>';
invitation=invitation.replace('</style>',partyCss+'</style>');

const partyBanner='<div class="party-time-card" data-party-time="v7"><span class="time-kicker">FIESTA</span><span class="time-value">3:00 P.M.</span><span class="time-note">A partir de las 3 de la tarde</span></div>';
